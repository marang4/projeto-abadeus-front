...
export function CadastroClientePage() {
  ...
  const dateInputRef = useRef<HTMLInputElement>(null); // Ref para o seletor de data
  ...
  // Função para lidar com a escolha do calendário nativo
  ...
  return (
    <div 
      ...
      style={{ backgroundColor: "#ffffff", maxWidth: "650px", border: "1px solid #f1f5f9" }}
    >
      ...
      {errorMessage && <div className="alert alert-danger text-center border-0 p-2 mb-3" style={{ fontSize: "0.85rem", backgroundColor: "#fef2f2", color: "#991b1b" }}>{errorMessage}</div>}
      {successMessage && <div className="alert alert-success text-center border-0 p-2 mb-3" style={{ fontSize: "0.85rem", backgroundColor: "#ecfdf5", color: "#065f46" }}>{successMessage}</div>}
          ...
          <div className="col-12 col-md-6 text-start">
            ...
            <div className="input-group">
              ...
              <span
                ...
                onClick={() => dateInputRef.current?.showPicker()} // Aciona o calendário nativo
              >
                <i className="bi bi-calendar3" style={{ color: azulSistema }}></i>
              </span>
              {/* Input de data escondido para usar o seletor nativo */}
              <input
                ref={dateInputRef}
                type="date"
